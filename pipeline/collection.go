...
// When using Flow with "flow.New", this collection contains a graph with one pipeline in it.
// When using Flow with "flow.NewMulti", this collection contains a graph with several pipelines in it.
